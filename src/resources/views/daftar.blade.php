    ...
    <div class="container pt-5">
      <div class="row">
        <div class="col-md-12 order-md-1">
          <h4 class="mb-3">Daftar Sekarang</h4>
          <form class="needs-validation" method="POST" action="{{ route('daftar') }}">
            <div class="row">
              <div class="col-md-6 mb-3">
                <label for="firstName">Nama depan</label>
                <input type="text" class="form-control" id="firstName" placeholder="Inputkan nama belakang Anda" name="firstname" required>
              </div>
              <div class="col-md-6 mb-3">
                <label for="lastName">Nama belakang</label>
                <input type="text" class="form-control" id="lastName" placeholder="Inputkan nama belakang Anda" name="lastname" required>
              </div>
            </div>

            <div class="mb-3">
              <label for="email">Email</label>
              <input type="email" class="form-control" id="email" name="email" placeholder="Inputkan email Anda">
            </div>
            <hr class="mb-4">
